...
5-minute interval that contains the maximum number of average steps is **`r interval_max_steps$interval`**.
...
Considering data with no missing values, the average number of steps taken per day is **`r round(daily_steps_mean_nomissing, 2)`** and the median is **`r round(daily_steps_median_nomissing, 2)`**.  
